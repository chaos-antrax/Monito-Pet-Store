...
const BannerText = () => {
  return (
    <div className="px-4 pt-6 md:mt-[-25px] md:pr-16 z-10 items-center md:items-end justify-center h-full flex flex-col text-[#002a48] relative">
      <span className="text-[36px] md:text-[52px] font-bold">
        One More Friend
      </span>
      <span className="text-[24px] md:text-[36px] font-bold mt-1">
        Thousands More Fun!
      </span>
      <span className="text-[12px] text-center md:text-right mt-4 md:max-w-[375px]">
